...
contract WTON is ReentrancyGuard, Ownable, ERC20, ERC20Burnable, OnApprove, ERC20OnApprove {
     ...
     */
    function _decodeTONApproveData(bytes memory data) internal pure returns (address depositManager, address layer2) {
    ...
    function _encodeDepositManagerOnApproveData(address layer2) internal pure returns (bytes memory data) {
        data = new bytes(0x20);
